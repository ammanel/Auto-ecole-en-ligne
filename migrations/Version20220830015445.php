 ...
 */
final class Version20220830015445 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE document (id INT AUTO_INCREMENT NOT NULL, compte_id INT DEFAULT NULL, typedoc_id INT DEFAULT NULL, rappel_id_id INT DEFAULT NULL, date_etablissement DATE NOT NULL, enable TINYINT(1) DEFAULT NULL, INDEX IDX_D8698A76F2C56620 (compte_id), INDEX IDX_D8698A76D6223D7 (typedoc_id), INDEX IDX_D8698A76B4B78D97 (rappel_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
